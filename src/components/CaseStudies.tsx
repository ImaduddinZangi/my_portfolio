...
const CASE_STUDIES: CaseStudy[] = [
  {
    ...
    alts: [
      "Optima.AI partner dashboard listing test kits and order status",
      "Optima.AI personalised health report generated by LLM pipeline",
      "Optima.AI multi-tenant admin panel with Stripe billing overview",
    ],
  },
  {
    id: "cdi-tech",
    ...
    alts: [
      "CDI Tech Utility Point browser app showing geospatial inspection routing on Google Maps",
      "CDI Tech Station Point desktop dashboard with inspection schedules and engineer assignments",
      "CDI Tech Inspection Point Lite mobile companion for field data capture",
    ],
  },
  {
    id: "mills-car",
    ...
    alts: [
      "Mills ERP double-entry accounting ledger with dynamic invoicing",
      "Car dealership vehicle inventory dashboard with profit analytics charts",
      "Multi-warehouse stock tracking interface showing raw material movements",
    ],
  },
];
      ...
      <div className="bg-paper py-16 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-2 text-base text-ink/60">
            Fifteen minutes. Your operation, my honest assessment.
          </p>
          <div className="mt-6">
            <a
              href={BOOKING_URL}
